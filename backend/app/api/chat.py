...
async def chat_endpoint(
    ...
    student = {
        ...
        "qualification_year": student_model.qualification_year,
        "score_type": student_model.score_type,
        "academic_score": student_model.academic_score,
        "english_test_taken": student_model.english_test_taken,
        "english_test_type": student_model.english_test_type,
        "english_overall_score": student_model.english_overall_score,
        "english_lowest_score": student_model.english_lowest_score,
        "english_goal": student_model.english_goal,
        "planned_english_test": student_model.planned_english_test,
        "target_countries": student_model.target_countries,
        "preferred_field": student_model.preferred_field,
        "intended_study_level": student_model.intended_study_level,
        "preferred_intake": student_model.preferred_intake,
        "budget_range": student_model.budget_range,
